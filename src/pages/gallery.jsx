...
const GalleryPage = () => {
  ...
  className="text-4xl md:text-5xl font-bold mb-6 inline-block relative after:content-[''] after:block after:h-1 after:bg-blue-500 after:w-70 after:mx-auto after:mt-2"
>
